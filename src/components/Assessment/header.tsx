...
export default function Header(props: {
    ...
    return (
        <div className='w-[100vw] md:w-[100%] flex flex-col md:flex-row items-center justify-start md:h-[75px] border-b-2'>
            
            <div className='border-r-2 h-[70%] w-[100%] md:w-auto flex justify-start items-center mx-2 p-2'>
                {width < 768 && <MenuButton />}
                <h1 className='text-2xl ml-4 font-semibold'>Assessment</h1>
            </div>
